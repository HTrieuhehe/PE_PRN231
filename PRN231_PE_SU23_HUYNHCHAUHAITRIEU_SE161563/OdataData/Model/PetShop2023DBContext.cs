...
//                optionsBuilder.UseSqlServer("Server=(local);Database=PetShop2023DB;User ID=sa;Password=12345678", x => x.UseNetTopologySuite());
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PetShopMember>(entity =>
            {
                entity.HasKey(e => e.MemberId)
                    .HasName("PK__PetShopM__0CF04B38B977AF27");

                entity.ToTable("PetShopMember");

                entity.HasIndex(e => e.EmailAddress, "UQ__PetShopM__49A14740FB93CC11")
                    .IsUnique();
